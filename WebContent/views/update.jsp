...
<body>
	...
	<form action="../updateServlet" name="myform" method="POST">
	...
	<div>
		<button>
			<a href="/ShoppingSite/index.jsp">ホームへ戻る</a>
		</button>
	</div>
	<script src="/ShoopingSite/js/registerJs.js"></script>
	<script src="/ShoppingSite/js/update.js"></script>
</body>
</html>